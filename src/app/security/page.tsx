...
export default function SecurityPage() {
  return (
    <main style={{ maxWidth: 1040, margin: "0 auto", padding: "56px 20px 80px", lineHeight: 1.6, color: "#08090d" }}>
      <Link href="/" style={{ color: "#2647f0", fontWeight: 750, textDecoration: "none" }}>ForkFirst</Link>
      <p style={{ margin: "48px 0 10px", color: "#2647f0", fontSize: 12, fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase" }}>
      ...
      <p style={{ fontSize: 19, color: "#5c6470", maxWidth: 720, margin: 0 }}>
      ...
      <p style={{ margin: "22px 0 0" }}>
        <a href={securityAdvisoryUrl} target="_blank" rel="noreferrer" style={{ color: "#2647f0", fontWeight: 850 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14, marginTop: 42 }}>
        {trustCards.map((card) => (
          <article key={card.title} style={{ border: "1px solid #ded6c4", borderRadius: 18, padding: 20, background: "#fbf8ef" }}>
            <h2 style={{ fontSize: 19, lineHeight: 1.15, margin: "0 0 10px" }}>{card.title}</h2>
      ...
      <section style={sectionStyle}>
        ...
        <p style={{ color: "#5c6470", maxWidth: 720 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: 10, marginTop: 20 }}>
          {builderCards.map((builder) => (
            <div key={builder} style={{ border: "1px solid #ded6c4", borderRadius: 14, padding: "13px 14px", background: "#fffdf7", fontWeight: 750 }}>
              {builder}
            </div>
          ))}
        </div>
